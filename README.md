...
```
cobs/
├── include/cobs/            # Public headers
│   ├── cobs.h               # Main API header
│   └── cobs_types.h         # Common types and definitions
├── src/                            # Implementation
│   ├── cobs.c               # Core implementation
│   └── cobs_int.c           # Internal utilities
├── test/                           # Unit tests (Unity framework)
│   ├── CMakeLists.txt              # Test build configuration
│   ├── test_cobs.c          # Example test file
│   └── README.md                   # Testing guide
├── cmake/                          # CMake modules
│   └── cobsConfig.cmake.in  # Package config template
...
clang-format -i include/cobs/myheader.h
```
...
See [test/README.md](file:///home/dogukanarat/workspace/cobs/test/README.md) for a comprehensive guide on writing tests with Unity.
...
- Header files to `/usr/local/include/cobs/`
- CMake config files to `/usr/local/lib/cmake/cobs/`
...
GitHub: [dogukanarat/cobs](https://github.com/dogukanarat/cobs)
